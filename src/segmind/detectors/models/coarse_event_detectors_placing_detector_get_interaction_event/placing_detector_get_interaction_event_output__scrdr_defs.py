...
from segmind.datastructures.events import PlacingEvent, StopTranslationEvent, TranslationEvent
...
def conditions_73076948442184610140058021308995926047(case) -> bool:
    def conditions_for_placing_detector_get_interaction_event(self_: PlacingDetector, output_: Union[NoneType, PlacingEvent]) -> bool:
        ...
        return isinstance(self_.starter_event, StopTranslationEvent)
...
def conclusion_73076948442184610140058021308995926047(case) -> Optional[PlacingEvent]:
    def placing_detector_get_interaction_event(self_: PlacingDetector, output_: Union[NoneType, PlacingEvent]) -> Union[NoneType, PlacingEvent]:
        ...
        latest_translation_event = starter_event.object_tracker.get_first_event_of_type_before_event(TranslationEvent, self_.starter_event)
        return PlacingEvent(self_.tracked_object, timestamp=latest_translation_event.timestamp, end_timestamp=self_.starter_event.timestamp)
